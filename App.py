...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='suraj',db='cv')
...
def run():
    ...
    img = Image.open('./Logo/image.png')
    st.image(img)
    st.sidebar.markdown("# Choose Something...")
    activities = ["User", "Feedback", "About", "Admin"]
    choice = st.sidebar.selectbox("Choose among the given options:", activities)
    link = '<b>Made by <a href="https://dnoobnerd.netlify.app/" style="text-decoration: none; color: #021659;">200 - ok</a></b>' 
